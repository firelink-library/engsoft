...
import workflow1 from '../../../assets/devops/workflow1.png';
import workflow2 from '../../../assets/devops/workflow2.png';
import configPages from '../../../assets/devops/config_pages.png';
import prFix from '../../../assets/devops/pr_fix.png';
...
<p><center>Interface de workflows do github.</center></p>
...
<p><center>Outra run de workflow</center></p>
...
<p><center>Configuração do github pages</center></p>
...
<center>
  <Image
    src={prFix}
    alt="Testes automatizados salvando prod"
    style={{ height: 'auto' }}
  />
</center>
<p><center>Correção de PR após testes acusarem erro.</center></p>

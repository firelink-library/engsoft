...
<Tabs>
  <TabItem label="Antes">
  ```js del={14-20} title="docusaurus.config.js"
  ...
  presets: [
    [
      'classic',
  ...
  ```js ins={14} title="docusaurus.config.js"
  ...
  presets: [
    [
      'classic',
...
<Tabs>
  <TabItem label="Antes">
  ```js del={20} title="docusaurus.config.js"
  ...
  themeConfig:
...
<Tabs>
  <TabItem label="Antes">
  ```js del={4-7} title="docusaurus.config.js"
  ...
    title: 'More',
    items: [
      {
...
<Tabs>
  <TabItem label="Antes">
  ```js {7-13} title="docusaurus.config.js"
  ...
  presets: [
    [
      'classic',
  ...
  <TabItem value="depois" label="Depois">
  ```js {7-14} ins={13} {title="docusaurus.config.js"
  ...
  presets: [
    [
      'classic',

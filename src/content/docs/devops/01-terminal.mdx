...
1. **echo**: Imprime uma linha de texto ou variáveis de ambiente.
...
1. **cat**: Exibe o conteúdo de arquivos textos.
...
1. **touch**: Cria arquivos vazios ou atualiza a data de criação/atualização de
   arquivos.
...
1. **rm**: Remove um ou mais arquivos.
...
1. **rmdir**: Remove uma pasta vazia.
...
1. **man**: Exibe a documentação detalhada do comando.
...
1. **tldr**: Proporciona uma visão simplificada do comando.
